use protocol::basic::BaseResponse;
use protocol::goodbye::goodbye_server::Goodbye;
use protocol::goodbye::{GoodbyeRequest, GoodbyeResponse};
use protocol::hello::hello_server::Hello;
use protocol::hello::{HelloRequest, HelloResponse};
use std::fmt::format;
